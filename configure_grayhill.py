...
if __name__ == "__main__":
    ...
    try:
        ...
        msg = can.Message(arbitration_id=0x18EF80FD, data=[0x13,0x00], is_extended_id=True)
        print_can_msg(msg)
        bus.send(msg)
        time.sleep(0.1)
        # Button Transmit Period = 0 (no periodic transmission)
        msg = can.Message(arbitration_id=0x18EF80FD, data=[0x14,0x00], is_extended_id=True)
        print_can_msg(msg)
        bus.send(msg)
        time.sleep(0.1)
        # Indicator Status Send On Event = False
        msg = can.Message(arbitration_id=0x18EF80FD, data=[0x18,0x00], is_extended_id=True)
        print_can_msg(msg)
        bus.send(msg)
        time.sleep(0.1)
        # Indicator Status Transmit Period = 0 (no periodic transmission)
        msg = can.Message(arbitration_id=0x18EF80FD, data=[0x19,0x00], is_extended_id=True)
        print_can_msg(msg)
        bus.send(msg)
        time.sleep(0.1)
        ...
        msg = can.Message(arbitration_id=0x18EF80FD, data=[0x27,0x00], is_extended_id=True)
        print_can_msg(msg)
        bus.send(msg)
        time.sleep(0.1)
        # AUXIO1 Send On Event = False
        msg = can.Message(arbitration_id=0x18EF80FD, data=[0x2A,0x00], is_extended_id=True)
        print_can_msg(msg)
        bus.send(msg)
        time.sleep(0.1)
        # AUXIO1 TX Period = 0 (no periodic transmission)
        msg = can.Message(arbitration_id=0x18EF80FD, data=[0x2B,0x00], is_extended_id=True)
        print_can_msg(msg)
        bus.send(msg)
        time.sleep(0.1)
    except BaseException as err:
